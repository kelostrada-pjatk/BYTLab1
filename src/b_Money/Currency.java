...
public class Currency {
     ...
     * "universal" exchange rate. Imagine that we define the rate of each
     * currency in relation to some universal currency. This means that the rate
     * of each currency defines its value compared to this universal currency.
     *
    ...
    public Integer valueInThisCurrency(Integer amount, Currency otherCurrency) {
        Double d = otherCurrency.universalValue(amount) / rate;
        return d.intValue();
    }
}
